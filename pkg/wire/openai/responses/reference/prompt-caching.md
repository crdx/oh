...
For GPT-5.6 and later, 1,024 tokens is a strict minimum. For earlier models, the minimum varies by model from 1,024 to 2,048 tokens, so prompts just above 1,024 tokens may not cache consistently.
